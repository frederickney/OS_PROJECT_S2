...
EXE=ftp_mqtt
HOST=HOST
OBJ=bin/main.o bin/socket.o bin/cmd_interpreter.o bin/get_request.o bin/reply.o bin/file_opener.o bin/file_access.o bin/stdin_filter.o bin/server.o bin/utils.o
